...
import 'package:musica/DB/Fuctionprofile/model.dart';
...
class _ProfiewidgetState extends State<Profiewidget> {
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage('assets/images/profileq.jpeg')),
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                      onPressed: () {}, child: const Text('Add Profile')),
                ),
                Padding(
  ...
  Future<void> savebuttonclick() async {
   ...
   final userprofile=Profilemodel(username: name);
