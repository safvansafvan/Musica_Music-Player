        ...
        child: ValueListenableBuilder(
          ...
          builder: (context, Box<Playermodel> musiclist, child) {
            return Hive.box<Playermodel>('playlistdata').isEmpty
                ?const Center(child: Text('No Playlist Found',style: TextStyle(fontWeight: FontWeight.w600),))
                : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container( 
                      ...
                      child: ListTile(
                        ...
                        trailing:
                          const  Icon(Icons.add,color: Color.fromARGB(255, 37, 37, 54),),
                      ),
...
void songaddtoplaylist( SongModel data ,datas,String name,BuildContext context){
